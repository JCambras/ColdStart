  ...
  return (
    <PageShell logoStacked navBelow={tabBar}>
      ...
      <footer style={{
        ...
        <span style={{ fontSize: 11, color: colors.textMuted }}>
          <a href="/terms" style={{ color: colors.textMuted, textDecoration: 'underline' }}>Terms</a>
          {' · '}
          <a href="/privacy" style={{ color: colors.textMuted, textDecoration: 'underline' }}>Privacy</a>
        </span>
      </footer>
    </PageShell>
  );
