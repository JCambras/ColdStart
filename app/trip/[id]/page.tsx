  ...
  return (
    <div style={{ minHeight: '100vh', background: colors.bgPage, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '0 24px 60px' }}>
          ...
          <>
            <section style={{
              ...
              {hasGames && trip.games![0]?.sheet && (() => {
                ...
                if (!note) return null;
                return (
                  <div style={{ marginTop: 10, padding: '8px 12px', background: '#eff6ff', borderRadius: 8, borderLeft: `3px solid ${colors.brandAccent}`, fontSize: 12, color: '#1e40af' }}>
        ...
        {/* ── Cost Breakdown ── */}
        {hasCosts && (
          <section style={{ background: '#fafff8', border: `1px solid ${colors.successBorder}`, borderRadius: 14, padding: 20, marginTop: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
